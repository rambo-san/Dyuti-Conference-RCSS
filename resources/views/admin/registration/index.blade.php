                    ...
                    <table id="reg" class="table table-striped table-bordered">
                        ...
                        @foreach($data as $dat)
                            ...
                            <tr>
                                ...
                                <td><a href="{{ route('registration.view', ['id' => $dat->id]) }}"><i class="fa fa-eye"></i></a></td>
                                
                                <!-- <td><a href="{{ route('registration.error') }}"><i class="fa fa-eye"></i></a></td> -->
                                
                                <td>
                                    @if($dat->approve_status == 0)
                                        <a href="{{ route('registration.approve', ['id' => $dat->id]) }}"><i class="fa fa-check-square-o"></i></a>
                                    @else
                                        Approved
                                    @endif
                                </td>
                                <td><a href="{{ route('registration.delete', ['id' => $dat->id]) }}"><i class="fa fa-trash"></i></a></td>
