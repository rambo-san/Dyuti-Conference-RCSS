  ...
  <div class="panel panel-default">
        <div class="card card-primary card-outline">
            ...
            @endif
                <div class="panel-body">
                    <table border="1" width="100%" cellpadding="10px">
                        ...
                        <tr><th>Food</th><td>{{($data->food==0)?"Veg":"Non-Veg"}}</td></tr>
                         <tr><th>ICSD Member</th><td>@if($data->icsd) Yes @else No @endif </td></tr>
                          <tr><th>ICSD Member Proof</th><td>@if($data->proof) <a href="https://conference.rajagiri.edu/icsd//storage/{{$data->proof}}" target="_blank">View Proof</a> @else -- @endif </td></tr>
                ...
                <a href="{{route('registration')}}"><button class="form-control btn-success" style="width: 100px;">Back</button></a>
            </div>
        </div>
    </div>
@endsection
